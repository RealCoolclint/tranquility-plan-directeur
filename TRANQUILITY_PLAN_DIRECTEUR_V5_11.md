...
| I3 | Launcher bugs (Installer + Resend) | 🟡 En attente — fichiers src/ requis |
...
1. **Bugs Launcher** — dès que `src/renderer/app.js` et `src/main/main.js` disponibles
2. **Chantier I5** — `managers.json` sur tranquility-core — Bloc B
...
*Plan Directeur V5.10 — 30 mai 2026 — Tranquility Suite · Cellule Vidéo L'Étudiant*
*Remplace V5.10*
*Phase Mercury : ✅ Clôturée — 9 avril 2026*

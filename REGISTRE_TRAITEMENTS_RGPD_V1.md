...
|---|---|
| Nom de famille | Non nécessaire à l'identification dans les outils |
...
| Resend | Sous-traitant — service d'envoi email transactionnel | Email + prénom (pour notifications) | USA — DPA disponible |
...
*Registre des activités de traitement · V1.0 · L'Étudiant · Tranquility Suite · 18 juin 2026*

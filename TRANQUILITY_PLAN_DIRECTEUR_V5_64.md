...
`CARNET_PIEGES_V25_COMPLET.md` — 4 juillet 2026 · migré sur GitHub le 04/07/2026 (repo privé `tranquility-carnet-pieges`, branche `main`) — même garantie de récupération intégrale que ce document via `raw.githubusercontent.com`. Le fichier reste également disponible en ressource projet Claude, mais **le repo GitHub fait foi** en cas de divergence.
...
| `CARNET_PIEGES_V25_COMPLET.md` | Carnet de pièges empirique | V25 — 04/07/2026 ✅ **Migré sur GitHub** (repo `tranquility-carnet-pieges`, commit `928fca7`) — même garantie de récupération que le Plan Directeur. Ancien fichier V24 + les deux patches obsolètes (`V22→V23`, `V23→V24`) à retirer des ressources projet Claude |

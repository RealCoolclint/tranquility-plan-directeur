...
`CARNET_PIEGES_V26_COMPLET.md` — 4 juillet 2026 (soirée) · sur GitHub (repo privé `tranquility-carnet-pieges`, branche `main`) — même garantie de récupération intégrale que ce document via `gh api` (repo privé, `raw.githubusercontent.com` inaccessible sans token). Le fichier reste également disponible en ressource projet Claude, mais **le repo GitHub fait foi** en cas de divergence. V26 ajoute 5 entrées de la session R5-bis Chantier A (test bout-en-bout).
...
| `SESSION_TRAVAIL_20260705_VEILLE_OUTILS_INSTRUCTIONS.md` | Récap session — veille outils fondatrice (7 projets, ntfy → I8), rangement thématique des instructions permanentes JARVIS (V2.0), correction de comportement (accusés de réception répétitifs) | 05/07/2026 ✅ |
| `CARNET_PIEGES_V26_COMPLET.md` | Carnet de pièges empirique | V26 — 04/07/2026 (soirée) ✅ sur GitHub (repo `tranquility-carnet-pieges`) — 5 nouvelles entrées (session R5-bis Chantier A). **Reste à faire (ressources projet Claude, manuel) :** retirer `CARNET_PIEGES_V24_COMPLET.md` + les deux patches obsolètes (`V22→V23`, `V23→V24`), et le V25, ajouter le V26 à la place |
...
| `CARNET_PIEGES_V26_COMPLET.md` (GitHub) | Carnet de pièges — repo dédié | V26 — repo `tranquility-carnet-pieges`, branche `main` |

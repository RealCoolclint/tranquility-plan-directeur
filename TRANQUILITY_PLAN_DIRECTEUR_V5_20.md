...
|---|-------|----------|-------|
| 7 | **ROVER** | 1 — En cours | **V1.04.06.26** ✅ — Session/profils ✅ · versioning ✅ · binaires standalone ✅ · Git LFS ✅ · build + DMG + release ✅ · interface améliorée ✅ — Compression abandonnée (décision 5/06/2026) — **APPS_CATALOG Launcher ✅ 5/06/2026** — Prochain : Chantier I1 (bugs Launcher) |
...
*Plan Directeur V5.20 — 5 juin 2026 — Tranquility Suite · Pôle Vidéo L'Étudiant*
*Remplace V5.19*
*Phase Mercury : ✅ Clôturée — 9 avril 2026*
*Phase Gemini : Ouverte — ROVER V1.04.06.26 ✅ — compression abandonnée 5/06/2026 — ROVER dans APPS_CATALOG Launcher ✅ 5/06/2026*

...
| 3 | Session Recap | 1 — Fondateur | ⚫ À construire |
| 4 | Audit Complétude | 1 — Fondateur | ⚫ À construire |
...
3. **Bugs Launcher** — dès que `src/renderer/app.js` et `src/main/main.js` disponibles

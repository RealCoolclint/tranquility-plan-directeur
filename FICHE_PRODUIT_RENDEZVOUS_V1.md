...
**Gérer les niveaux d'accès de manière invisible** — Quatre niveaux de profil (N1 Opérateurs, N2 Périphériques, N3 Observateurs, N4 Institutionnels) + ADMIN. Une app non autorisée n'est pas bloquée — elle est invisible. Ce qu'on ne voit pas, on ne peut pas l'utiliser mal.
...
**Règle d'invisibilité :** une app non autorisée n'apparaît pas. Ce qu'on ne voit pas, on ne peut pas le casser.
...
*Fiche produit · RENDEZVOUS · V1.1 · Tranquility Suite · Cellule Vidéo L'Étudiant · 18 juin 2026*
